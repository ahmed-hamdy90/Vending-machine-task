(() => {
    ...
    /**
     * Represent Custom Error Class for any Invalid API router
     */
    class InvalidApiRouteError extends Error {
        ...
        constructor(message, field = null) {
            ...
            if (Error.captureStackTrace) {
                Error.captureStackTrace(this, InvalidApiRouteError);
            }
        }
    }

    module.exports = InvalidApiRouteError;
})();